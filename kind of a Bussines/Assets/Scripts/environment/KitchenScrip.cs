...
public class KitchenScrip : MonoBehaviour
{
   ...
   public BGCcMath AskPath() {
        ...
        if (random <= 2 && timerON2 == false)
        {
            curve = curve2;
            timerON2 = true;
            Debug.Log("inside");
        }
        if (random <= 3 && timerON3 == false)
        {
            curve = curve3;
            timerON3 = true;
            Debug.Log("inside");
        }
        if (random <= 4 && timerON4 == false)
        {
            curve = curve4;
            timerON4 = true;
            Debug.Log("inside");
        }
        if (random <= 5 && timerON5 == false)
        {
            curve = curve5;
            timerON5 = true;
            Debug.Log("inside");
        }
        if (random <= 6 && timerON6 == false)
        {
            curve = curve6;
            timerON6 = true;
            Debug.Log("inside");
        }
        if (random <= 7 && timerON7 == false)
        {
            curve = curve7;
            timerON7 = true;
            Debug.Log("inside");
        }
        if (random <= 8 && timerON8 == false)
        {
            curve = curve8;
            timerON8 = true;
            Debug.Log("inside");
